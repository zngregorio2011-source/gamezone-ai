...
if (!API_KEY) {
    console.error("❌ OPENAI_API_KEY não foi encontrada no arquivo .env");
    process.exit(1);
}
...
app.post("/chat", async (req, res) => {
    try {
        ...
        /*
        Histórico recebido do front-end.
        Mantemos apenas mensagens válidas de usuário e assistente.
        */
        ...
        /*
        Evita duplicar a mensagem atual caso o front-end
        também a tenha colocado no histórico.
        */
...
app.get("/", (req, res) => {
    res.json({
        status: "online",
        message: "🎮 GameZone AI API funcionando!",
        endpoint: "POST /chat"
    });
});
